...
<style type="text/css">
  .information_dataTables .dataTables_filter {
    margin-top: 20px;
    margin-bottom: 14px;
    right: 38px;
}
                      ...
                      <div class="tab-pane active" id="header" role="tabpanel">
                          <div id="datatable_wrapper" class="information_dataTables dataTables_wrapper dt-bootstrap4 table-responsive">
                              ...
                              <div class="d-flex exportPopupBtn">
                                <a href="{{ url('/admin/addtenants') }}" class="btn button btn-info btn-align" >Add Tenants</a>
                              </div>
            ...
            $('#search_tenant').click(function(){
              let j = 1;
                ...
                $('#table_id').DataTable({
                  ...
                  ajax: {
                      type: 'POST',
                      url: '{{ url("/admin/get_all_building_tenants") }}',
                      data: {
