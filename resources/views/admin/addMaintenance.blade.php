        ...
        <div class="container-fluid pt-1 py-4 px-0">
          <div class="row justify-content-center">
            <div class="col-lg-6 col-md-12 mb-4">
                <div class="card p-5">
                  <form action="{{ url('/admin/add_maintenance_form') }}" method="post" class="information_form" enctype="multipart/form-data">
                    @csrf
                  <div class="row">
                    <div class="col-md-12">
    ...
    <script>
      $(document).ready(function() {
          ...
          $( "#city" ).change(function() {
                ...
                $.ajax({
                      type: 'POST',
                      url: "{{ url('/admin/get_area_data') }}" + '/' + city,
                      dataType: "json",
                      async:false,
                      data: city,
                      headers: {
                        ...
                        console.log(result.area);
                          ...
                          if(result.area.length == 1){
                            ...
                            $.ajax({
                              ...
                              $.ajax({
                                    type: 'POST',
                                    url: "{{ url('/admin/get_floors') }}" + '/' + building,
                                    dataType: "json",
                                    async:false,
                                    data: building,
                                    headers: {
