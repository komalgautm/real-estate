               ...
               <div class="main_navbg">
                  ...
                  <div class="">
                    ...
                    <div class="collapse navbar-collapse" id="collapsibleNavbar">
                      ...
                      @foreach($staff_users as $userdata)
                     
                        <li class="nav-item"><a class="nav-link" href="{{url('staff/dashboard')}}"><i class="mdi mdi-account-details-outline"></i>Dashboard</a></li>
                        @if($userdata->permission[0] == 1)
                          <li class="nav-item"><a class="nav-link" href="{{url('staff/tenants')}}"><i class="mdi mdi-account-cog-outline"></i> Tenants</a></li>
                        @endif

                        @if($userdata->permission[2] == 1)
                        <li class="nav-item"><a class="nav-link" href="{{url('staff/payment')}}"><i class="mdi mdi-sale"></i> Payments</a></li>
                        @endif
                        @if($userdata->permission[4] == 1)
                        <li class="nav-item"><a class="nav-link" href="{{url('staff/maintenance')}}"><i class="mdi mdi-card-account-details-outline"></i> Maintenance Expenses</a></li>
                        @endif
                        <!-- @if($userdata->permission[6] == 1)
                        <li class="nav-item dropdown dropdown_position">
                        ...
                        <li class="nav-item"><a class="nav-link" href="{{ url('staff/profile') }}"><i class="mdi mdi-account-cog-outline"></i> Profile</a></li>
            ...
            <ul class="navbar-nav  justify-content-end">
              ...
              <li class="nav-item dropdown adminProfile pe-2 d-flex align-items-center">
                ...
                <a href="javascript:;" class="nav-link d-flex p-0 dropdown-toggle" id="dropdownSettingButton" data-bs-toggle="dropdown" aria-expanded="false">
                 <span class="profileImg"><img src="{{ url('assets/img/staff_profile/'.$userdata->staff_iamge)}}" alt="Profile"></span>
                 
                  <span class="proName">{{ $userdata->name}}</span>
                </a>
                <ul class="dropdown-menu  dropdown-menu-end me-sm-n4" aria-labelledby="dropdownSettingButton">
                  <li class="profiledropMenu"><a class="dropdown-item border-radius-md" href="{{ url('/staff/set_password') }}">Set Password</a> </li>
                  <li class="profiledropMenu"> <a class="dropdown-item border-radius-md" href="{{url('staff/logout')}}"> Logout  </a> </li>                 
                </ul>
              </li>
            </ul>
          </div>
