  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
          ...
          <div class="row justify-content-center">
            <div class="col-lg-6 col-md-12 mb-4">
                <div class="card p-5">
                  ...
                  <form action="{{ url('/staff/add_payment_form') }}" method="POST" name="myForm" class="information_form" enctype="multipart/form-data" onsubmit="return validateForm()">
                    @csrf
                  <div class="row">
                    <div class="col-md-12">
    ...
    <script>
        $(document).ready(function() {
            ...
            $.ajax({
                type: "POST",
                url: "{{ url('/staff/get_all_area_data')}}",
                dataType: "json",
                async:false,
                headers: {
            ...
            $('#area').change(function(){
                ...
                $.ajax({
                type: "POST",
                url: "{{ url('/staff/get_building_data_ajax')}}"  + '/' + id,
                dataType: "json",
                async:false,
                headers: {
                                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            ...
            $('#building').on('change', function(){
                ...
                $.ajax({
                  type: "POST",
                  url: "{{ url('/staff/get_apartment_data_ajax')}}"  + '/' + id,
                  dataType: "json",
                  async:false,
                  headers: {
                                  'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
