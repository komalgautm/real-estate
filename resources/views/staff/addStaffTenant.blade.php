        ...
        <div class="container-fluid pt-1 py-4 px-0">
          <div class="row justify-content-center">
            <div class="col-lg-6 col-md-12 mb-4">
                <div class="card p-5">
                  <form action="{{ url('/staff/add_tenant_staff') }}" method="POST" class="information_form" enctype="multipart/form-data">
                    @csrf
                  <div class="row">
                    <div class="col-md-12">
                  ...
                  <div class="row mt-1">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="input-group">
                        <select name="apartment_no" class="form-control" id="apartment" required>
                          <option value="">Select</option>
                        </select>
                      </div>
                    </div>
